...
// import selectShowCompanyUseHook from "hooks/useSelectShowCompany";

// const { getUserData, isToggle, setIsToggle, selectUserData } =
//   selectShowCompanyUseHook();
...
//   public async initMap({ testData }: any) {
...
//       testData,
//       (v) =>
//         _.filter(testData, (v1) => v1.companyName === v.companyName).length > 1
//     );

//     console.log(duplicatedCompany);
